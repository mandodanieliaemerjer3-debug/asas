...
export default function PagamentoMestreMogu() {
  ...
  const finalizarPedido = async () => {
    ...
    try {
      ...
      // 🛡️ DEFINIÇÃO DE STATUS DE SEGURANÇA
      // Pix e Gateway ficam travados até o pagamento ser detectado ou o comprovante enviado.
      const statusSeguro = (formaPagamento === "Pix" || formaPagamento === "Gateway") 
      ...
      const dadosPedido = {
        ...
        status: statusSeguro, // Aplicando a trava de segurança
  ...
  return (
    <main className="min-h-screen bg-zinc-950 p-6 flex flex-col items-center justify-center font-sans">
      <div className="bg-white text-black p-10 rounded-[50px] w-full max-w-sm shadow-2xl">
        <h2 className="text-center font-black italic uppercase mb-8 tracking-tighter">Forma de Pagamento</h2>
